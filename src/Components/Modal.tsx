...
const Modal = () => {
  ...
  const handleInsertResponse = () => {
    ...
    if (messageInputElement) {
      messageInputElement.innerHTML = `<p>${response}</p>`
    }
    handleCloseModal()
  }
      ...
      {showModal ? (
        <div className="modal-container" onClick={handleCloseModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            />
            <button className="modal-button" onClick={handleGenerate}></button>
            {response && (
              <>
                <p className="response">{response}</p>
                <button className="modal-button" onClick={handleInsertResponse}>
                  Insert
                </button>
              </>
            )}
